...
def generate_batched_data(data, label, batch_size=32, shuffle=False, seed=None):
    ...
    if shuffle:
        ...
        data_shuffled, label_shuffled = zip(*combined)
        data = list(data_shuffled)
        label = list(label_shuffled)
...
def plot_curves(train_loss_history, train_acc_history, valid_loss_history, valid_acc_history):
    ...
    # Plot loss
    plt.subplot(1, 2, 1)
    plt.plot(train_loss_history, label='Loss - Train', color='blue')
    plt.plot(valid_loss_history, label='Loss - Val', color='red')
    plt.title('Loss')
    plt.xlabel('Epochs')
    plt.ylabel('Loss')
    plt.legend()
    ...
    # Plot accuracy
    plt.subplot(1, 2, 2)
    plt.plot(train_acc_history, label='Accuracy - Train', color='blue')
    plt.plot(valid_acc_history, label='Accuracy - Val', color='red')
    plt.title('Accuracy')
    plt.xlabel('Epochs')
    plt.ylabel('Accuracy')
    plt.legend()
